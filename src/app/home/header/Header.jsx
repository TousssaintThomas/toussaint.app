...
import HeroAnimation from '@/app/home/header/_hero-animation/HeroAnimation'
    ...
    const HeroTxt = () => (
        ...
        >
            ...
            >
                ...
                <h1 className={`${styles['dev-title']}`}>{HeaderText.title}</h1>
                <p className={`${styles['hero-sub-text']}`} ref={HeroSubTxtBot}>
                    {HeaderText.subText}
                </p>
